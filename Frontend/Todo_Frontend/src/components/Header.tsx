...
function Header() {
  const {
    ...
    setIsLoading,
    loading,
    userName, // You might want to use this, or remove it if it's not needed.
    setUserName, // You might want to use this, or remove it if it's not needed.
  ...
  const handleLogout = async () => {
    ...
    try {
      ...
      console.log(data);
      setIsLoading(false);
    } catch (error: any) { // Explicit 'any' type, because error handling can be broad.
      setIsAuth(true);
